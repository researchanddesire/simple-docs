...
description: "This guide covers RADR's settings menu, WiFi configuration, and power management options."
---
...
<Callout type="info" title={"WiFi setup portal doesn't appear"}>
...
<Callout type="info" title={"WiFi doesn't connect to my network"}>
...
<Callout type="info" title={"Update fails"}>
...
<Callout type="info" title={"Device won't wake from sleep"}>
