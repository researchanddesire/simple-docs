...
description: "This guide explains how RADR discovers nearby Bluetooth devices and establishes connections."
---
...
<Callout type="info" title={"Device doesn't appear in scan"}>
...
<Callout type="info" title={"Connection fails repeatedly"}>
...
<Callout type="info" title={"Connection drops frequently"}>
