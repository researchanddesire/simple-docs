...
description: "Keeping your Research And Desire wireless Remote (RADR) updated ensures you have the latest features, bug fixes, and support for new Bluetooth devices. Updates are quick and easy — just a few taps from the Settings menu."
---
...
Go to the [RADR Web Flasher](/radr/guides/user-guide/web-flasher) in Chrome, Edge, or another compatible browser.
...
<Callout type="info" title={"Update fails or gets stuck"}>
...
- If updates consistently fail, use the [Web Flasher](/radr/guides/user-guide/web-flasher)

</Callout>

<Callout type="info" title={"RADR won't turn on after update"}>
...
3. Use the [Web Flasher](/radr/guides/user-guide/web-flasher) to reinstall firmware

</Callout>

<Callout type="info" title={"New device still not recognized after update"}>
...
<Callout type="info" title={"How do I know what version I'm running?"}>
