...
description: "RADR supports Lovense Bluetooth devices with a simplified vibration-only control interface. This guide covers how to control Lovense devices."
---
