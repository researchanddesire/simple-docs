...
![RADR remote layout: screen, three buttons, left/right knobs, and bumpers](<../../img/image (1).webp>)
...
![Play Controls screen with speed and adjustment indicators](<../../img/image (2).webp>)
...
![Pattern Mode screen with a library of motion patterns](<../../img/image (3).webp>)
