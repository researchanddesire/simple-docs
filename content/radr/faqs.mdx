...
description: "Find answers to common questions about setting up, using, and troubleshooting your RADR wireless remote."
---

## Controls & Buttons

<Callout type="info" title={"One bumper button feels different or has no tactile feedback"}>
...
<Callout type="info" title={"What do the bumper buttons do?"}>
...
<Callout type="info" title={"How do I connect RADR to my OSSM?"}>
...
<Callout type="info" title={"Why won't RADR find my OSSM?"}>
...
<Callout type="info" title={"Is RADR compatible with older OSSM board versions?"}>
...
<Callout type="info" title={"My RADR makes a rattling sound when shaken"}>
...
<Callout type="info" title={"How do I charge RADR?"}>
...
<Callout type="info" title={"How do I get replacement parts?"}>
...
<Callout type="info" title={"Who should I contact for RADR support?"}>
