...
<AccordionGroup>
  <Accordion title="What payment methods do you accept?">
    ...
    **Need an invoice?** If you'd like to pay via bank transfer or need a custom invoice (for example, with specific items or modifications), contact [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us). We can send you an invoice directly for payment.

    <Card title="Contact support" icon="envelope" href="https://www.researchanddesire.com/pages/contact-us">
  ...
  <Accordion title="Do you ship internationally?">
    ...
    <Card title="Contact us" icon="envelope" href="https://www.researchanddesire.com/pages/contact-us">
  ...
  <Accordion title="Can my package be seized by customs?">
    ...
    **If your package is seized by customs:**
    ...
    - Contact us at [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number
  ...
  <Accordion title="Do your products have CE marking for EU import?">
    ...
    **If you're concerned about EU import regulations:**
    ...
    - Contact us at [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) if you have questions about shipping to your location
  ...
  <Accordion title="Can I upgrade my shipping speed after placing my order?">
    Yes, you can upgrade to faster shipping after checkout—as long as your order hasn't shipped yet. Email [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number and request a shipping upgrade.
  ...
  <Accordion title="Do you ship to P.O. boxes?">
    ...
    **If this happens:**
    ...
    - Contact us immediately at [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number and an alternate street address
  ...
  <Accordion title="My tracking hasn't updated for weeks. Is my package lost?">
    ...
    **What to do if tracking hasn't updated for 2 weeks or more:**
    ...
    1. Contact us at [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number and tracking number
  ...
  <Accordion title="Customs or UPS is asking me to provide additional documentation">
    ...
    **What to do:**
    ...
    1. Forward the request to [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us)
  ...
  <Accordion title="My package shows delivered but I can't find it">
    ...
    **If you still can't locate the package:** Contact [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number. We'll work with the carrier to investigate and help resolve the issue.
  ...
  <Accordion title="Can I cancel my order?">
    Yes, you can cancel your order before it ships. Email [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number and we'll process the cancellation.
  ...
  <Accordion title="What is your return or refund policy?">
    ...
    However, we never want a customer stuck with a device they don't want. If you're unhappy with your purchase for any reason, contact [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) and we'll work with you to find a solution.
  ...
  <Accordion title="Can I add items to my order after checkout?">
    Yes, you can add items to an existing order before it ships. Email [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number and the items you'd like to add. We'll send you an invoice for the additional items.
  ...
  <Accordion title="Can I change or remove items from my order?">
    Yes, you can modify your order before it ships. Email [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number and the changes you'd like to make. You can:
  ...
  <Accordion title="Can I split my order and receive items separately?">
    ...
    **How it works:**
    ...
    - Email [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number and request to split the shipment
  ...
  <Accordion title="I forgot to apply a discount code. Can it still be applied?">
    Yes! If you forgot to enter a discount or promo code at checkout, contact [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number and the code you intended to use.
  ...
  <Accordion title="My discount code isn't working. What should I try?">
    ...
    If you've tried these steps and the code still doesn't work, contact [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with the code you're trying to use and a screenshot of the error (if any). We'll help resolve the issue or apply the discount manually.
  </Accordion>

  <Accordion title="Can I change my shipping address?">
    Yes, you can update your shipping address before your order ships. Email [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number and the correct address.
    ...
    **After your order has shipped:**
    ...
    <Note>
      Carrier redirect fees may apply. Contact [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) with your order number and the new address.
    </Note>
  </Accordion>
  ...
  <Accordion title="Can I change my billing address?">
    ...
    **If you need a different billing address:**
    ...
    - Contact [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) to cancel your order
