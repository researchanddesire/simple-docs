---
title: "Bounce Mode"
description: "Bounce Mode builds on the fundamentals of Repetition Mode with an added challenge: you control the pace in both directions. While Repetition emphasizes gradual insertion with quick withdrawals, Bounce requires steady, controlled rhythm for both downward and upward movements."
---
...
<Callout type="info" title={"My score drops during withdrawal"}>
...
<Callout type="info" title={"The target seems to move unpredictably"}>
...
<Callout type="info" title={"I keep getting yellow/red during direction changes"}>
