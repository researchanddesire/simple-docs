...
<Callout type="info" title="What comes with my Deepthroat Trainer order?">
...
## Setup & Mounting
<Callout type="info" title="Can I use the Trainer handheld instead of wall-mounted?">
...
<Callout type="info" title="Can I wear the Trainer so a partner can practice on me?">
...
<Callout type="info" title="I don't have a suitable mounting surface. What can I do?">
...
## Compatible Toys
<Callout type="info" title="What toys can I use with my Deepthroat Trainer?">
...
<Callout type="info" title="Can I use the vibrating plug and wand at the same time?">
...
<Callout type="info" title="What size dildos are available for the Trainer?">
...
<Callout type="info" title="What size vibrating plugs are available?">
...
<Callout type="info" title="Can I use my own dildo with the Deepthroat Trainer?">
...
<Callout type="info" title="What is the maximum length the Deepthroat Trainer can sense?">
...
## Calibration
<Callout type="info" title="How do I recalibrate my toy's depth setting?">
...
<Callout type="info" title="Can I recalibrate my toy mid-session?">
...
<Callout type="info" title="Training requires depths that are physically impossible to reach">
...
## Training & Points
<Callout type="info" title="How does the Deepthroat Trainer track my performance?">
...
<Callout type="info" title="What are Training Points and how are they calculated?">
...
<Callout type="info" title="How does the leaderboard work?">
...
## Templates & Sessions
<Callout type="info" title="My multi-segment template only plays the first segment">
...
<Callout type="info" title="Do I need to restart the trainer to switch templates?">
...
<Callout type="info" title="Template editor stuck on 'loading' when saving">
...
<Callout type="info" title="Templates not syncing — device runs default/demo mode instead">
...
## Connectivity
<Callout type="info" title="Wi-Fi shows connected but device says offline">
...
<Callout type="info" title="Trainer stuck on 'Getting your settings'">
...
1. **Try manual USB flashing** — Use the [DTT Web Flasher](/dtt/tools/web-flasher) to reinstall firmware. See the [Firmware Updates](/dtt/technical/firmware-updates) guide for instructions.
...
<Callout type="info" title="Training won't start or the device shows a message about waiting">
...
<Callout type="info" title="Can I use my Trainer offline?">
...
<Callout type="info" title="How do I know if my firmware is up to date?">
...
<Callout type="info" title="Is my older Trainer eligible for firmware updates?">
...
<Callout type="info" title="How do I connect my Deepthroat Trainer to Wi‑Fi?">
...
<Callout type="info" title="How can I tell if my Trainer is connected to Wi‑Fi?">

When you power on the device, the display shows the current Wi‑Fi connection status in plain text.

</Callout>
<Callout type="info" title="Wi-Fi doesn't stay connected after restarting the device">
...
## Care & Maintenance
<Callout type="info" title="How do I clean my Deepthroat Trainer?">
...
<Callout type="info" title="How do I clean and care for my dildo?">
...
<Callout type="info" title="I accidentally used silicone lube on my dildo. Should I throw it out?">
...
<Callout type="info" title="Why are so many features marked as Ultra-only?">
...
<Callout type="info" title="How does the AI Training Schedule work?">
...
<Callout type="info" title="How do I subscribe to Ultra?">
...
<Callout type="info" title="What is the segment repeat feature?">
...
<Callout type="info" title="What is Pass/Fail Mode?">
...
<Callout type="info" title="What is Hands‑Free Mode?">
...
<Callout type="info" title="Does my keyholder need Ultra to create advanced templates for me?">
...
<Callout type="info" title="I get an error when adding more than 3 segments to my partner's template">
...
<Callout type="info" title="Can I give my keyholder control of the Trainer but not the Lockbox (or vice versa)?">
...
<Callout type="info" title="How do I sell or donate my Deepthroat Trainer?">
...
## Account & Pairing
<Callout type="info" title="I can't access my dashboard account. How do I unpair my device?">
...
## Troubleshooting
<Callout type="info" title="Toybox and template buttons are greyed out">
...
<Callout type="info" title="Can't find the settings menu on my device">
...
<Callout type="info" title="LED lights up but the screen doesn't turn on">
...
<Callout type="info" title="Device won't turn on at all">
...
<Callout type="info" title="Can I replace the battery in my Trainer?">
...
<Callout type="info" title="Accessory port only works at certain angles or has intermittent connection">
...
## Privacy & Discretion
<Callout type="info" title="How does the Trainer appear on my WiFi network?">
...
<Callout type="info" title="Is there an open API for the Deepthroat Trainer?">
...
## Device Information
<Callout type="info" title="Is the Deepthroat Trainer compatible with OSSM?">
...
<Callout type="info" title="How do I find my Trainer ID?">

Your five‑character alphanumeric Trainer ID displays on screen during startup.

</Callout>
<Callout type="info" title="My Trainer ID shows jumbled characters or changes on every reboot">
...
<Callout type="info" title="I have questions not covered here. Who should I contact?">
...
<Callout type="info" title="How long does the battery last, and how long does it take to charge?">
