...
description: "When your trainer encounters an issue, it displays an error code or message on screen. This guide explains what each error means and how to resolve it."
---
...
<Callout type="info" title={"Device shows error then freezes"}>
...
<Callout type="info" title={"Error appears immediately after power-on"}>
...
<Callout type="info" title={"Errors during training"}>
