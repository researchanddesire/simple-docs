...
description: "This guide is for contributors who want to help with documentation and do not want to spend time learning the tooling first."
---
...
When the preview is ready, open [http://localhost:8000](http://localhost:8000).
