...
description: "How to Do an Emergency Unlock"
---
...
<Callout type="info" title={"I held the button but don’t see Emergency Unlock"}>
...
<Callout type="info" title={"The device seems frozen or has no display"}>
...
<Callout type="info" title={"I used hardware unlock but the dashboard still shows a lock"}>
...
<Callout type="info" title={"I triggered emergency unlock by mistake—can I undo it?"}>
