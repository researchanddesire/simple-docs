...
description: "Automatic pairing connects your Lockbox to your dashboard account directly over Bluetooth. The dashboard reads your device, links your account, and provisions WiFi credentials — all in one flow, without any manual steps on the device itself."
---
...
<Callout type="info" title={"My Lockbox doesn't appear in the browser picker"}>
...
<Callout type="info" title={"The connection drops before pairing completes"}>
...
<Callout type="info" title={"WiFi credentials were sent but the Lockbox didn't connect"}>
...
<Callout type="info" title={"I see 'Scan for Lockbox' but clicking it does nothing"}>
