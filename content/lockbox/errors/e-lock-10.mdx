...
description: "Error E‑LOCK‑10 means your Chastity Lockbox failed to join a Wi‑Fi network. Cloud features like the web dashboard, remote updates, and partner notifications won’t work until the device reconnects. The Lockbox still operates locally with its current settings."
---
