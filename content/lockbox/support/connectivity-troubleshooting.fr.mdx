...
Envoyez un e-mail à [support@researchanddesire.com](https://www.researchanddesire.com/pages/contact-us) si le problème persiste sur plusieurs réseaux, si le tableau de bord signale à plusieurs reprises un état incorrect ou si une session est bloquée. Incluez l'e-mail du compte, la version du micrologiciel affichée, la couleur de l'indicateur, le modèle du routeur, l'état du verrouillage actif et les étapes déjà essayées.