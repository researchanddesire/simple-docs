...
description: "If your Lockbox and the dashboard are showing different states — for example, the dashboard says \"Offline\" while your device shows a green connection indicator, or your lock session isn't behaving as expected — this guide covers the most common causes and fixes."
---
