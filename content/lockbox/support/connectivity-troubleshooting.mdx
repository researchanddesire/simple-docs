...
Email [support@researchanddesire.com](mailto:support@researchanddesire.com) if the problem remains on multiple networks, the dashboard repeatedly reports the wrong state, or a session is stuck. Include the account email, displayed firmware version, indicator color, router model, active lock state, and steps already tried.
