---
title: "Lockbox Sleep and Power States"
description: "Compare Lockbox idle, pseudo-sleep, and deep-sleep behavior, connectivity, and wake actions."
---
...
The timings below describe the currently documented behavior. Firmware can change power-management timing. If your device behaves differently, use the screen and connectivity indicators as the source of truth and contact support with the displayed firmware version.
...
| State        | Timeout    | Screen       | Wi-Fi        | Best for                |
| ------------ | ---------- | ------------ | ------------ | ----------------------- |
...
3. **Pseudo-sleep (2 minutes)** — Screen turns off, Wi-Fi stays connected
4. **Deep sleep (10 minutes)** — Wi-Fi disconnects, minimal power use
...
- Wi-Fi stays connected for Keyholder communication
...
- Screen, Wi-Fi, Bluetooth, and most sensors turn off
...
The device will boot up and reconnect to Wi-Fi automatically.

</Callout>
<Callout type="warn">

While in deep sleep, the Lockbox cannot receive remote Keyholder commands. Confirm the Lockee has local and emergency access before using it during a session.
...
## Best practices
<Callout type="info" title="Maximize battery life">
...
<Callout type="info" title="Stay connected to your keyholder">
