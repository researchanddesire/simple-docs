...
<img src="/ossm/img/power-supply-annotated.webp" alt="" />
2. Plug the barrel jack end of the power supply into the barrel jack port on your OSSM board
<img src="/ossm/img/enclosed-ossm-pcb-annotated1.webp" alt="" />
3. Check that the board's LED lights up, and let the device home
<img src="/ossm/img/enclosed-ossm-pcb-annotated2.webp" alt="" />
...
You can control your OSSM using one of three different remote types:
  ...
  1. Wired Remote <img src="/ossm/docs/img/wired-remote.webp" alt="" />
  2. Wireless Remote (RADR) <img src="/ossm/docs/img/wireless-remote-unannotated.webp" alt="" />
  3. Web Controller <img src="/ossm/docs/img/web-controller-play-interface.webp" alt="" />
...
The Wired Remote has a left and a right knob.
  ...
  <img src="/ossm/img/wired-remote-annotated.webp" alt="" />
...
<img src="/ossm/img/wireless-remote-annotated.webp" alt="" />
...
3. The Wireless Remote will detect your OSSM. Use the right button to select your OSSM <img src="/ossm/img/wireless-remote2-annotated.webp" alt="" />
...
The Wireless Remote has a Bluetooth connectivity indicator, a WiFi connectivity indicator, and a battery life indicator. You can find them displayed at the top centre of the device screen.
  ...
  <img src="/img/bt-wifi-battery-indicators.png" alt="" />
...
The Web Controller allows you to control your OSSM without a physical remote. This remote method requires that your OSSM is connected to WiFi. For instructions on connecting your OSSM to WiFi using the Web Controller, [click this link.](#wifi-setup-option-1) The interface for the Web Controller looks like this:
  ...
  <img src="/ossm/docs/img/web-controller-play-interface.webp" alt="" />
...
3. Click "Connect" and select your OSSM, then click "Pair" <img src="/img/web-controller-connect-annotated.png" alt="" />
4. Select your OSSM and click "Pair" <img src="/ossm/img/web-controller-pair-annotated.webp" alt="" />
5. Once paired, click on the "WiFi Settings" tab at the top of the Web Controller interface <img src="/img/web-controller-wifisettings-annotated.png" alt="" />
6. Enter your WiFi network's name and password <img src="/ossm/img/web-controller-wifisettings2-annotated.webp" alt="" />
...
4. Select "Settings" <img src="/ossm/docs/img/wireless-remote-wifi-connectivity-settings-unannotated.webp" alt="" />
5. Select "Wifi Settings" <img src="/ossm/docs/img/wireless-remote-wifi-connectivity-wifi-settings-unannotated.webp" alt="" />
6. Using your phone camera, scan the QR code that appears on the device screen <img src="/ossm/docs/img/wireless-remote-wifi-connectivity-wifi-qr-code-unannotated.webp" alt="" />
7. On your phone or computer, connect to the WiFi network named "OSSM Setup" <img src="/ossm/docs/img/radr-wifi-setup-annotated.webp" alt="" />
8. Select "Configure WiFi" <img src="/ossm/docs/img/wifi-manager-annotated.webp" alt="" />
9. Select your WiFi network (this will auto-fill the SSID info), enter your WiFi password, and click save <img src="/ossm/docs/img/radr-wifi-network-selection-annotated.webp" alt="" />
