...
You can control your OSSM using one of three different remote types:
  ...
  1. Wired Remote ![](../img/wired-remote.png)
  2. Wireless Remote (RADR) ![](../img/wireless-remote-unannotated.png)
  3. Web Controller ![](../img/web-controller-play-interface.png)
...
4. Select "Settings" ![](../img/wireless_remote_wifi_connectivity_settings_unannotated.png)
5. Select "Wifi Settings" ![](../img/wireless-remote-wifi-connectivity-wifi-settings-unannotated.png)
6. Using your phone camera, scan the QR code that appears on the device screen ![](../img/wireless_remote_wifi_connectivity_wifi_QR_code_unannotated.png)
7. On your phone or computer, connect to the WiFi network named "OSSM Setup" ![](../img/RADR-wifi-setup-annotated.png)
8. Select "Configure WiFi" ![](../img/WiFi-manager-annotated.png)
9. Select your WiFi network (this will auto-fill the SSID info), enter your WiFi password, and click save ![](../img/RADR-WiFi-network-selection-annotated.png)
