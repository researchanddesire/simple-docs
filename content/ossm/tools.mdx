...
description: "All R+D PCBAs are shipped pre-flashed, but there may be some instances that require you to flash your device at home. We've created an easy flashing tool for this purpose!"
---

<Callout type="info" title={"You must use Google Chrome or Microsoft Edge to flash your device."} />

<Callout type="warning" title={"Flash your device only when instructed to by support@researchanddesire.com"} />
