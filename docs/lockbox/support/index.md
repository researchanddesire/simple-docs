...
!!! tip
    If you have a general product question, start with the [Lockbox FAQs](../faqs.md). If you are actively troubleshooting, use the sections below.

## Connection and Sync Problems

**[Check Online Status](online-status.md)**
...
**[Emergency Unlock: Break the Backplate](emergency-backplate.md)**
