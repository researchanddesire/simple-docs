...
<Card title="Hard Reboot Procedure" icon="rotate" href="/lockbox/technical/button-controls#hard-reboot-with-resync">
...
<CardGroup cols={2}>
<Card title="Alpha Updates" icon="flask" href="/lockbox/support/alpha-updates">
  How to enroll in or leave the alpha program.
</Card>
<Card title="Firmware Flashing" icon="rotate" href="/lockbox/support/flashing">
