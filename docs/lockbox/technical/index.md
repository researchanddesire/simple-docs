...
!!! note
    If you're looking for basic setup help, start with the [Quick Start Guide](../quick-start/index.md) instead.
...
**[Idle and Power States](idle-and-power-states.md)**
...
## Advanced options
**[Alpha Updates](../support/alpha-updates.md)**
