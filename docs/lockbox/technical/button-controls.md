...
description: "Complete guide to button inputs, encoder navigation, and control functions on your Chastity Lockbox"
---
...
<Card title="Restarting Device" icon="rotate" href="../device-states/restarting">
