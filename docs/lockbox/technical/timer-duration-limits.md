...
description: "Complete reference for lock timer durations, from 30 seconds to 1000 years"
---
...
<Card title="Permalock Mode" icon="infinity" href="../device-states/permalock">
...
<Card title="Hiding Time" icon="eye-slash" href="../using/hiding-time">
