...
### Step 2: Select Emergency Unlock
...
!!! tip
If you only need a temporary pause for hygiene or comfort, consider using <b>Take a Break</b> instead of an emergency unlock. See <a href="/lockbox/device-states/take-a-break">Take a Break</a>.
...
- Follow the hardware procedure: <a href="/lockbox/support/emergency-backplate">How to do an Emergency Unlock by breaking the Backplate</a>
...
<AccordionGroup>
??? note "I held the button but don’t see Emergency Unlock"
...
- The feature may be disabled for your session. If so, use the hardware method: <a href="/lockbox/support/emergency-backplate">hardware emergency unlock</a>.

??? note "The device seems frozen or has no display"

- Plug in power and try again.
- Restart the device: see <a href="/lockbox/device-states/restarting">Restarting Device</a>.
- If it’s still unresponsive and you must access the key, use the hardware method.

??? note "I used hardware unlock but the dashboard still shows a lock"
...
??? note "I triggered emergency unlock by mistake—can I undo it?"
...
<Card title="Restarting Device" icon="refresh" href="/lockbox/device-states/restarting">
How to safely restart if the UI is unresponsive.
</Card>

<Card title="Hardware Emergency Unlock" icon="tool" href="/lockbox/support/emergency-backplate">
Destructive fallback method when the software option is unavailable.
</Card>

<Card title="FAQs" icon="question" href="/lockbox/faqs">
