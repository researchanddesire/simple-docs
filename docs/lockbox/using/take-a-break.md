...
description: "Learn how to temporarily unlock your Chastity Lockbox for hygiene, play, or any other reason during a lock session."
---
...
### Step 3: Complete your break
  ...
  !!! warning
If the timer reaches zero while your key is still out, your keyholder will be notified and a permanent failure will be recorded on your account. This does not apply to test locks.
...
This won't be a problem if you're running a test lock, and you can read more about test locks in future documentation.
