...
On the Wired Remote you access patterns through the "Stroke Engine" selection.
...
- Insist - Tiny rapid pulses. Sensation affects whether the feeling of stroke thrust comes from the base or tip of the rail.
...
- The OSSM is compatible only with a 2.4GHz WiFi network
