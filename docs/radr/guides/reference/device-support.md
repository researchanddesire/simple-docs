...
!!! tip
For the smoothest setup, keep your device firmware up to date and follow the <a href="../getting-started/quick-start">Quick Start</a> to pair.
...
Charge your RADR via USB‑C. If your OSSM or RADR needs an update, flash using the <a href="/ossm/guides/getting-started/web-flasher">Web Flasher</a>.
...
Follow the <a href="../getting-started/quick-start">Quick Start</a> to scan. RADR only lists supported devices; if yours appears, select to connect.
...
!!! note
{/* TODO: Internal table required for support list. */}
For the complete list of pending devices, see the full [device support documentation](https://buttplug.io).
...
- Update firmware where applicable: <a href="/ossm/guides/getting-started/web-flasher">Flashing your OSSM</a>
