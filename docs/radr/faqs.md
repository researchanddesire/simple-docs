...
description: "Common questions and answers about the RADR wireless remote"
---
...
<Card title="OSSM Controls Guide" icon="sliders" href="/radr/guides/user-guide/ossm-controls">
...
<Card title="Quick Start Guide" icon="rocket" href="/radr/guides/getting-started/quick-start">
...
1. Update your OSSM firmware to version 2.0.0 or later using the [Web Flasher](/ossm/guides/getting-started/web-flasher)
...
<Card title="Flash your OSSM" icon="microchip" href="/ossm/guides/getting-started/web-flasher">
...
<Card title="RADR Bill of Materials" icon="list" href="https://github.com/researchanddesire/radr-wireless-remote/tree/main/Hardware">
