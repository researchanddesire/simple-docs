...
<CardGroup cols={2}>
  <Card title="Customize your avatar" icon="user" href="https://dashboard.researchanddesire.com/settings">
  ...
  <Card title="Unlock your first avatar" icon="gift" href="https://dashboard.researchanddesire.com/faqs">
...
<CardGroup cols={2}>
  <Card title="Ultra subscription benefits" icon="bolt" href="https://dashboard.researchanddesire.com/subscription">
    Learn what’s included in Ultra and how to upgrade.
  </Card>
  <Card title="Deepthroat Trainer FAQs" icon="question-mark-circle" href="/dtt/faqs">
...
<Card title="Browse Shareable Templates" icon="collection" href="/dtt/quick-start/templates">
