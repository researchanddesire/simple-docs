...
!!! info
Endurance Mode is ideal for building stamina and control. If you're just getting started, see <a href="/dtt/quick-start/introduction">Quick Start</a> first.
...
<AccordionGroup>
??? note "I can't reach my target duration"
...
??? note "My score drops when I adjust position"
...
??? note "The LED keeps flickering between colors"
...
<Card title="Points and leaderboards" icon="trophy" href="https://dashboard.researchanddesire.com/leaderboards/points">
