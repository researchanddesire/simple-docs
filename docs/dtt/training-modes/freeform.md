...
### Step 1: Create or open a training template
...
### Step 2: Add a Freeform segment

Choose Add Segment → Freeform. Set the target **RPM**, choose a **duration** (20 minutes is the default), and select the **toy** you’ll use.

!!! warning
    If you haven’t calibrated depth on this toy, do that first in a structured mode (e.g., <a href="/dtt/training-modes/repetition">Repetition</a>) so measurements are accurate.

### Step 3: Save and set active
