...
description: "Troubleshoot the 'No Internet. Check Firewall and Router' error on your Trainer device"
---
...
<AccordionGroup>
??? note "Create an allow rule for the Trainer"
...
??? note "Adjust IoT device settings"
